...
import getFullAccountDataForEBNumber from "@salesforce/apex/CustomerCardController.getFullAccountDataForEBNumber";
import { registerListener, unregisterAllListeners, fireEvent } from './fcs_PubSub';
...
export default class CustomerCard extends LightningElement {
    ...
    async findCustomerAsync(){
        ...
        try{
            ...
            if(account){
                this.accountId = account.Id;
                this.customerName = account.FirstName + ' ' + account.LastName
                this.customerIdentified = true
